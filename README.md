...
# Inspiration
We were inspired by the technological advancements being made for self-driving cars; however, after a little brainstorming we realized that motorcyclists’ conditions for safety have not followed the trend of advanced technology protection as car drivers’ have, and current safety measures are not as efficient as they could be. For example, motorcyclists are about 26 times more likely to die than their driver counterparts are in a collision. And the most common type of motorcycle accident involved a car turning left at an intersection. Thus we wanted to make a project that would increase safety for motorcyclists and reduce the number and lethality of accidents.
